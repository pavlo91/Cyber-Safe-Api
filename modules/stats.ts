...
const GQLStatByDay = pothos.objectRef<StatsByDay['stats'][0]>('StatByDay')
const GQLStatsByDay = pothos.objectRef<StatsByDay>('StatsByDay')

GQLStatByDay.implement({
  fields: (t) => ({
...
GQLStatsByDay.implement({
  fields: (t) => ({
    stats: t.expose('stats', { type: [GQLStatByDay] }),
